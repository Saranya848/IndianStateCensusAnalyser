	...
	public int readData(String DATA_FILE) throws StateCensusAnalyserException {
		...
		if (!DATA_FILE.contains(".csv")) {
			throw new StateCensusAnalyserException(
					censusanalyzer.StateCensusAnalyserException.ExceptionType.INVALID_TYPE,
					"Invalid Class Type in the File!! \nInvalidTypeException thrown....");
		}
		try {
			...
			while ((line = br.readLine()) != null) {
				if (!line.contains(","))
					throw new StateCensusAnalyserException(
							censusanalyzer.StateCensusAnalyserException.ExceptionType.INVALID_DELIMITER,
				...
				if (count == 0) {
					...
					if (!(headerArray[0].equals("State") && headerArray[1].equals("Population")
						...
						throw new StateCensusAnalyserException(
								censusanalyzer.StateCensusAnalyserException.ExceptionType.INVALID_HEADER,
